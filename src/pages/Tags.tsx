...
import { useTags, useCreateTag, useUpdateTag, useMergeTag, useDeleteTag } from '../hooks/useTags';
  ...
  return (
    <div className="p-3 sm:p-4 lg:p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6 sm:mb-8">
        <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Add New Tag</h2>
        <form onSubmit={handleCreateTag} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          ...
          <button
            ...
            className="px-4 sm:px-6 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base"
          >
            {createTag.isPending ? (
              'Adding...'
            ) : (
